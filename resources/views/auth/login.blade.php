    ...
    <div class="az-column-signup-left">
        <div>
            ...
            <p>Bengkel mobil motohid (pak tauhid) (Perbaikan mobil) berlokasi di Jawa Timur, Indonesia. 
                ...
                Alamat Bengkel mobil motohid (pak tauhid) Cantuk Lor, Cantuk, Singojuruh, Kabupaten Banyuwangi, Jawa Timur 68464, Indonesia</p>
            <p>Address <br>
        ...
        <div class="az-signup-header">
            ...
            <form method="POST" action="{{ route('login') }}">
                ...
                <div class="row row-xs">
                    <div class="col-sm-12"><a class="btn btn-block" href="{{ route('google.login') }}" style="background-color: #c82333;"><i class="fab fa-google"></i> Masuk
                            dengan Google</a></div>
                </div><!-- row -->
            </form>
